...
def eval_split(model, crit, loader, eval_kwargs={}):
    ...
    dataset = eval_kwargs.get('dataset', '')
    ...
    loss_evals = 1e-8
    predictions = []
    n_predictions = [] # when sample_n > 1A
    ...
    while True:
        ...
        if labels is not None and verbose_loss:
            ...
            with torch.no_grad():
                ...
                loss = crit(model(fc_feats, att_feats, labels[..., :-1], src1, src2, src3, src4, adj1, adj2,
                                  adj3, adj4, att_masks), labels[..., 1:], masks[..., 1:]).item()
        ...
        with torch.no_grad():
            ...
            seq, seq_logprobs = model(fc_feats, att_feats, src1, src2, src3, src4, adj1, adj2, adj3, adj4, att_masks, opt=tmp_eval_kwargs, mode='sample')
            seq = seq.data
        ...
        for k, sent in enumerate(sents):
            ...
            if eval_kwargs.get('dump_images', 0) == 2:
