...
def if_use_feat(caption_model):
    ...
    if caption_model in ['updown', 'topdown']:
...
def parse_opt():
    ...
    # Data input settings
    parser.add_argument('--input_json', type=str, default='./data/data_res.json',
                    help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_fc_dir', type=str, default='',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default='./data/image_fetures',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='',
                    help='path to the directory containing the boxes of att feats')
    parser.add_argument('--input_label_h5', type=str, default='./data/data_tgt_label.h5',
                    help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_src_h5', type=str, default='./data/data_src_label.h5',
                        help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_adj_h5', type=str, default='./data/data_adj_label.h5',
                        help='path to the h5file containing the preprocessed dataset')
    ...
    parser.add_argument('--hidden_size', type=int, default=300,
                        help='GCN hiddin_size')
    parser.add_argument('--d_inner', type=int, default=300,
                        help='GCN inner')
    parser.add_argument('--enc_hiddin', type=int, default=1024,
                        help='GCN enc_hiddin')
    ...
    parser.add_argument('--optim_alpha', type=float, default=0.8,
                    help='alpha for adam')
    parser.add_argument('--optim_beta', type=float, default=0.99,
    ...
    parser.add_argument('--val_images_use', type=int, default=4963,
